...
<h1 class="text-3xl font-bold text-gray-800 mb-4">Manage Task Categories</h1>
...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="<?php echo Yii::app()->createUrl('taskCategory/create'); ?>" 
...
'view' => array(
						...
						'delete' => array(
							'label' => '🗑️',
							'url' => 'Yii::app()->createUrl("taskCategory/delete", array("id"=>$data->id))',
							'options' => array(
								'title' => 'Delete',
								'class' => 'inline-block bg-red-100 text-red-600 px-2 py-1 rounded hover:bg-red-200 transition text-sm',
								'onclick' => 'if(confirm("Are you sure you want to delete this task category?")) {
